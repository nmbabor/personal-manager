...
@section('content')
    <form action="{{ route('signup') }}" method="post" class="authentication-form px-lg-5 needs-validation" novalidate>
        @csrf
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    ...
                    <div class="single-row">
                        <div class="agreebox">
                            <div class="customcheck ">
                                <input type="checkbox" id="agree" class="customcheck-box" name="remember" hidden
                                    required>
